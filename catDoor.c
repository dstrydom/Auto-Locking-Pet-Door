/*	catDoor.c - $3/12/14$
 *	Name & E-mail: Danelze Strydom 
 *	CS Login: dstry002
 *	Assignment: Senior Design Project; (Helpful devices for the blind.)
 *	Exercise Description: My part of the project is to create a timed auto-locking/unlocking pet door.
 *	
